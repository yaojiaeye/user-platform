package yaojia.rest.client.core;
...
import static yaojia.rest.client.util.PathUtils.buildPath;
import static yaojia.rest.client.util.PathUtils.resolvePath;
import static yaojia.rest.client.util.URLUtils.*;
